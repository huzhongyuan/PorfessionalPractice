  ...
  <div>
      ...
      <div class="abstract">
          ...
          <div class="abstractContent" v-for="(item , index) in abstractDes" v-bind:key="index">
              <div class="abstractContentL">
                  {{ item.des }}
              </div>
              <div class="abstractContentM">
                {{ item.info }}
              </div>
              <div class="abstractContentR" @click="changeAabstract(item, index)">
                  {{ item.operate }}
              </div>
          </div>
      </div>
      ...
      <div class="abstract">
          ...
          <div class="abstractContent" v-for="(item , index) in manages" v-bind:key="index">
              ...
              <div class="abstractContentR" @click="changeManages(item, index)">
                  {{ item.operate }}
              </div>
          </div>
      </div>
